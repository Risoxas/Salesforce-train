Webruntime.define('lwc/detail', ['lwc', 'lightning/configProvider', 'c/data'], function (lwc, configProvider, data) { 'use strict';

  function stylesheet(hostSelector, shadowSelector, nativeShadow) {
    return "ebody" + shadowSelector + "{margin: 0;}\n.price" + shadowSelector + "{color: green;font-weight: bold;}\n";
  }
  ...
  **/
  ...
  function tmpl$2($api, $cmp, $slotset, $ctx) {
    ...
    return [$cmp.product ? api_element("div", {
      classMap: {
        "container": true
      },
      key: 9
      ...
      key: 0
    }, [api_dynamic($cmp.product.fields.Name.value)]), api_element("div", {
      classMap: {
        "price": true
      },
      key: 1
    }, [api_dynamic($cmp.product.fields.MSRP__c.displayValue)]), api_element("div", {
      classMap: {
        "description": true
      },
      key: 2
    }, [api_dynamic($cmp.product.fields.Description__c.value)]), api_element("img", {
      classMap: {
        "product-img": true
      },
      attrs: {
      ...
      props: {
        "label": $cmp.product.fields.Material__c.value
      },
      key: 4
    }, []), api_custom_element("lightning-badge", _lightningBadge, {
      props: {
        "label": $cmp.product.fields.Level__c.value
      },
      key: 5
    }, [])]), api_element("p", {
      key: 8
      ...
      props: {
        "label": $cmp.product.fields.Category__c.value
      },
      key: 7
    }, [])])]) : null, !$cmp.product ? api_element("div", {
      classMap: {
        "slds-text-heading_medium": true
      },
      key: 10
    }, [api_text("Select a bike")]) : null];
  }
  ...
  tmpl$2.stylesheetTokens = {
    hostAttribute: "lwc-detail_detail-host",
    shadowAttribute: "lwc-detail_detail"
  };

  class Detail extends lwc.LightningElement {
    constructor(...args) {
      super(...args);
      this.product = void 0;
    ...
    set productId(value) {
      ...
      this.product = data.bikes.find(bike => bike.fields.Id.value === value);
  ...
  lwc.registerDecorators(Detail, {
    publicProps: {
      productId: {
        config: 3
      }
    },
    fields: ["product", "_productId"]
  });

  var detail = lwc.registerComponent(Detail, {
    tmpl: _tmpl$3
  });
