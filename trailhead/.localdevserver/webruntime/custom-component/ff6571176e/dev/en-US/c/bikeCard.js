Webruntime.define('lwc/bikeCard', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';

    function stylesheet(hostSelector, shadowSelector, nativeShadow) {
      return ".price" + shadowSelector + " {color: green;font-weight: bold;}\n";
    }
    ...
    **/
    ...
    function tmpl$2($api, $cmp, $slotset, $ctx) {
      ...
      return [api_element("div", {
        ...
        key: 0
      }, [api_text("Name: "), api_dynamic($cmp.name)]), api_element("div", {
        key: 1
      }, [api_text("Description: "), api_dynamic($cmp.description)]), api_custom_element("lightning-badge", _lightningBadge, {
        props: {
          "label": $cmp.material
        },
        key: 2
        ...
        key: 4
      }, [api_text("Price: "), api_dynamic($cmp.price)]), api_element("div", {
        key: 6
      }, [api_element("img", {
        attrs: {
          "src": $cmp.pictureUrl
    ...
    tmpl$2.stylesheetTokens = {
      hostAttribute: "lwc-bikeCard_bikeCard-host",
      shadowAttribute: "lwc-bikeCard_bikeCard"
    };

    class BikeCard extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
    ...
    lwc.registerDecorators(BikeCard, {
      fields: ["name", "description", "category", "material", "price", "color", "pictureUrl"]
    });

    var bikeCard = lwc.registerComponent(BikeCard, {
      tmpl: _tmpl$3
    });
